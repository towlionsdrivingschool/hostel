...
const Card = () => {
  return (
    <div className="container ">
      ...
      <div className="flex max-sm:flex-col max-sm:justify-center items-center sm:pt-14 justify-between">
        <p className="text-2xl md:text-3xl text-black font-bold font-Poppins">
          Features
        </p>
        {/* <button classNameName="text-white font-Poppins font-medium max-md:hidden     bg-black rounded-[6px] px-6 py-2">
          View All
        </button> */}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-3 pt-11 pb-28">
        <div className="block rounded-xl border border-gray-800 p-4 hover:shadow-xl">
        ...
        <div className="block rounded-xl border border-gray-800 p-4 hover:shadow-xl">
          ...
          <h2 className="mt-2 font-semibold text-base sm:text-lg text-black">
            Hygienic dining hall and kitchen
          </h2>
          <p className="sm:mt-1 block text-sm sm:text-base text-black">
            {" "}
            Prototype ideas online, without depending on your local environment.
        ...
        <div className="block rounded-xl border border-gray-800 p-4 hover:shadow-xl">
          {/* <span className="inline-block rounded-lg p-3">
            <div className="inline-flex align-middle justify-center items-center select-nonetext-black">
              <svg
                viewBox="0 0 25 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <h2 className="mt-2 font-semibold text-base sm:text-lg text-black">
            Convenient location (near educational institutions, markets, etc.)
          </h2>
          <p className="sm:mt-1 block text-sm sm:text-base text-gray-300text-black">
